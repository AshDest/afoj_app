            ...
            <div class="col-lg-4 col-md-8 col-12">
                <div class="tiny-single-item">
                    <div class="tiny-slide">
                        <div class="card border-0 bg-white mx-auto text-center rounded border-0">
                            <div class="p-4 rounded pt-0">
                                <i class="mdi mdi-format-quote-open fs-1 text-primary"></i>
                                <p class="review font-italic text-muted mb-0">" It seems that only fragments of the
                                ...
                                <ul class="list-unstyled mb-0 mt-2">
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning fs-6"></i>
                                    </li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning fs-6"></i>
                                    </li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning fs-6"></i>
