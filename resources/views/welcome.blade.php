                ...
                <div class="col-lg-6">
                    <div class="content-wrap">
                        ...
                        <div class="banner-btn mt-40 md-mt-25">
                            <a class="readon slide-started" href="contact1.html"><span>Voir plus</span></a>
                        </div>
            ...
            <div class="row y-middle">
                <div class="col-lg-6 pr-65 md-pr-15 md-mb-50">
                    <div class="sec-title mb-30">
                        ...
                        <p class="desc small2">Leverage agile frameworks to provide a robust synopsis for high level
                            overviews. Iterative approaches to corporate strategy data foster to collaborative thinking to
                            empowerment.</p>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/1.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/2.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/3.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/4.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/5.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/6.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/7.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/8.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 md-mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/9.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 md-mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/10.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 xs-mb-30">
                    <div class="grid-figure">
                        <div class="logo-img">
                            <a href="https://rstheme.com/"><img src="assets/images/partner/style1/11.png"
                                    alt="Images"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 md-mb-50">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title"><a href="blog-single.html">How investing in dependend your business
                                    growth.</a></h3>
                            <div class="desc">We denounce with righteous indige nation and dislike men who are so
                                beguiled and demo realized by the charms of...</div>
                    ...
                    <div class="blog-horizontal">
                        <div class="blog-meta mb-30">
                            <div class="blog-item-wrap">
                                <div class="image-wrap">
                                    <a href="blog-single.html"><img src="assets/images/blog/style2/1.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                    ...
                                    <h3 class="blog-title"><a href="blog-single.html">How to maintain customers relations
                                            disaster.</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="blog-meta mb-30">
                            <div class="blog-item-wrap">
                                <div class="image-wrap">
                                    <a href="blog-single.html"><img src="assets/images/blog/style2/2.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                    ...
                                    <h3 class="blog-title"><a href="blog-single.html">7 Productivity tips to avoid burnout
                                            when working.</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="blog-meta">
                            <div class="blog-item-wrap">
                                <div class="image-wrap">
                                    <a href="blog-single.html"><img src="assets/images/blog/style2/3.jpg"
                                            alt=""></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                    ...
                                    <h3 class="blog-title"><a href="blog-single.html">There is so much to love about this
