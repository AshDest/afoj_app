...
<head>
	...
	<body class="defult-home">
	   	...
	   	<div id="pre-load">
            <div id="loader" class="loader">
                <div class="loader-container">
                    <div class="loader-icon"><img src="assets/images/fav.png" alt="Renovix - Business Consulting Html Template "></div>
                </div>
            </div>              
        </div>
		...
		<div class="main-content">
					...
					<nav class="right_menu_togle mobile-navbar-menu" id="mobile-navbar-menu">
					    ...
					    <ul class="nav-menu">
					    	<li class="menu-item-has-children current-menu-item">
					    		...
					    		<ul class="sub-menu">
					    			<li class="menu-item-has-children current-menu-item">
					    				<a href="index.html">Multipages</a>
					    				<ul class="sub-menu">
					    					<li class="active"><a href="index.html">Home 1</a></li>
					    					<li><a href="index2.html">Home 2</a></li>
					    					<li><a href="index3.html">Home 3</a></li>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="content-wrap">
								<span class="sub-text">Welcome To Renovix</span>
								<h1 class="title">We Help Building<br> Your<span> Business</span></h1>
								<p class="description">
									We are leading Business Consulting company all over the<br>
									world doing over 40 years.	
								</p>
								<div class="banner-btn mt-40 md-mt-25">
								    <a class="readon slide-started" href="contact1.html"><span>Get Started</span></a>
								</div>
					...
					<div class="row y-middle">
						...
						<div class="col-lg-6 pr-38 md-pr-15 pl-30 md-pl-15">
							<div class="sec-title mb-45 md-mb-25">
								...
								<p class="desc small2">On the other hand we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment so blinded by desire.</p>
							</div>
			...
			<div class="rs-services services-style2 pt-120 pb-120 md-pt-80 md-pb-80">
			    <div class="container">
			    	<div class="row mb-40 align-items-end">
			    		...
			    		<div class="col-lg-6">
			    			<div class="sec-title pb-10">
			    				<p class="desc small">On the other hand we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment so blinded by desire.</p>
			    			</div>
			    		</div>
			    	</div>
			    	<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
			    		<div class="rs-services-slider mt-45">
			    			<div class="content-part">
			    				...
			    				<p class="description"> Leverage agile frameworks the provide synopsis for high level Iterative approaches.</p>
			    			</div>
			    			<div class="bottom-part">
			    				<div class="services-icon">
			    					<img src="assets/images/services/style2/icons/1.png" alt="">
			    				</div>
			    		...
			    		<div class="rs-services-slider mt-45">
			    			...
			    			<div class="bottom-part">
			    				<div class="services-icon">
			    					<img src="assets/images/services/style2/icons/2.png" alt="">
			    				</div>
			    				<div class="services-btn">
			    		...
			    		<div class="rs-services-slider mt-45">
			    			...
			    			<div class="bottom-part">
			    				<div class="services-icon">
			    					<img src="assets/images/services/style2/icons/3.png" alt="">
			    				</div>
			    				<div class="services-btn">
			    		...
			    		<div class="rs-services-slider mt-45">
			    			...
			    			<div class="bottom-part">
			    				<div class="services-icon">
			    					<img src="assets/images/services/style2/icons/4.png" alt="">
			    				</div>
			    				<div class="services-btn">
			    	...
			    	<div class="services-item pt-20">
			    		<div class="row">
			    			<div class="col-lg-5 md-mb-30">
			    				<div class="services-btn-box">
			    					<div class="sec-title">
			    						<p class="desc small2">We have all the services to help your business. Leverage agile frameworks to provide.</p>
			    						<div class="btn-part mt-28">
			    						    <a class="readon slide-started more" href="services1.html"><span>All Services</span></a>
			    						</div>
			    					</div>
			    				</div>
			    			</div>
			    			<div class="col-lg-6">
			    				<div class="services-img">
			    					<img src="assets/images/services/style2/medium-shot.jpg" alt="Images">
			    				</div>
			    			</div>
			    		</div>
			    	</div>
	        		...
	        		<div class="row y-middle">
	        			<div class="col-lg-6 pr-65 md-pr-15 md-mb-50">
	        				<div class="sec-title mb-30">
	        					<span class="sub-text big-text">Our Approach</span>
	        					<h2 class="title title2 title-color pb-20">
	        						Building New Generation 
	        						Skillfull &<span> Productive</span>
	        					</h2>
	        					<p class="desc small2">Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy data foster to collaborative thinking to empowerment.</p>
	        				</div>
	        				<div class="row">
	        					<div class="col-lg-6">
	        				...
	        				<div class="rs-addon-services">
	        					<div class="services-wrap">
	        						<div class="services-icon">
	        							<img src="assets/images/approach/icon-bg.png" alt="Images">
	        						</div>
	        						<div class="services-content">
	        							<h5 class="title"> Call to ask any question </h5>
	        							<p class="services-txt"><a href="tel:+0885898745">(+088) 589-8745</a></p>
	        						</div>
	        					</div>
	        				</div>
	        				<div class="btn-part mt-40">
	        				    <a class="readon slide-started more" href="about.html"><span>Get Started</span></a>
	        				</div>
	        			</div>
	        			<div class="col-lg-6">
	        				<div class="appoach-img wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="0s">
	        					<img src="assets/images/approach/approch-3.png" alt="Images">
	        				</div>
	        			</div>
				...
				<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-md-device="3" data-md-device-nav="false" data-md-device-dots="true">
					...
					<div class="project-item">
					    <div class="project-img">
					   	...
					   	<div class="project-inner">
					   		<span class="category"><a href="portfolios-single.html">Consulting</a></span>
					   	    <h3 class="title"><a href="portfolios-single.html">Digital Customer Experience Strategy</a></h3>
					   	</div>
					</div>
					<div class="project-item">
					    <div class="project-img">
					   	...
					   	<div class="project-inner">
					   		<span class="category"><a href="portfolios-single.html">Marketing</a></span>
					   	    <h3 class="title"><a href="portfolios-single.html">Next-Generation Outsourcing Business</a></h3>
					   	</div>
					</div>
					<div class="project-item">
					    <div class="project-img">
			       		...
			       		<div class="col-lg-6 md-mb-50">
				            <div class="blog-item">
				                <div class="image-wrap">
				                    <a href="blog-single.html"><img src="assets/images/blog/style2/4.jpg" alt=""></a>
				                </div>
				            ...
				            <div class="blog-horizontal">
					            <div class="blog-meta mb-30">
					                <div class="blog-item-wrap">
	        			                <div class="image-wrap">
	        			                    <a href="blog-single.html"><img src="assets/images/blog/style2/1.jpg" alt=""></a>
	        			                </div>
	        			                <div class="blog-content">
	        			                	<ul class="blog-meta">
	        	                           		<li class="admin"><i class="fi  fi-rr-user"></i>RSTheme</li>
	        			                    ...
	        			                    <h3 class="blog-title"><a href="blog-single.html">How to maintain customers relations disaster.</a></h3>
	        			                </div>
					                </div>
					            </div>
					            <div class="blog-meta mb-30">
					                <div class="blog-item-wrap">
	        			                <div class="image-wrap">
	        			                    <a href="blog-single.html"><img src="assets/images/blog/style2/2.jpg" alt=""></a>
	        			                </div>
	        			                <div class="blog-content">
	        			                	<ul class="blog-meta">
	        	                           		<li class="admin"><i class="fi  fi-rr-user"></i>RSTheme</li>
	        			                    ...
	        			                    <h3 class="blog-title"><a href="blog-single.html">7 Productivity tips to avoid burnout when working.</a></h3>
	        			                </div>
					                </div>
					            </div>
					            <div class="blog-meta">
					                <div class="blog-item-wrap">
	        			                <div class="image-wrap">
	        			                    <a href="blog-single.html"><img src="assets/images/blog/style2/3.jpg" alt=""></a>
	        			                </div>
	        			                <div class="blog-content">
	        			                	<ul class="blog-meta">
	        	                           		<li class="admin"><i class="fi  fi-rr-user"></i>RSTheme</li>
	        			                    ...
	        			                    <h3 class="blog-title"><a href="blog-single.html">There is so much to love about this expertly crafted.</a></h3>
	        			                </div>
					                </div>
					            </div>
				            </div>
